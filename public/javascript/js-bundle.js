...
/***/ function(module, exports, __webpack_require__) {
	...
	var _configJson = __webpack_require__(157);

	var _configJson2 = _interopRequireDefault(_configJson);

	var _componentsStatusComponent = __webpack_require__(158);

	var _componentsStatusComponent2 = _interopRequireDefault(_componentsStatusComponent);

	var _componentsAbsenceComponent = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StatusComponent = (function (_WebserviceComponent) {
	    _inherits(StatusComponent, _WebserviceComponent);

	    function StatusComponent(props) {
	        _classCallCheck(this, StatusComponent);

	        _get(Object.getPrototypeOf(StatusComponent.prototype), 'constructor', this).call(this, props);
	    ...
	    _createClass(StatusComponent, [{
	        ...
	        value: function handleClick(event) {
	            _superagent2['default'].post(this.props.serviceURL).end((function (err, res) {
	                if (res && res.ok) {
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                'div',
	                { className: (0, _classnames2['default'])({ 'status': true, 'dnd': !this.state.available, 'available': this.state.available }), onClick: this.handleClick.bind(this) },
	                _react2['default'].createElement(
	                    'h1',
	                    { className: 'title status-title' },
	                    this.state.available ? this.props.textAvailable : this.props.textDnd
	                )
	            );
	        }
	    }]);
	...
	StatusComponent.propTypes = {
	    textDnd: _react2['default'].PropTypes.string.isRequired,
	    textAvailable: _react2['default'].PropTypes.string.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LogError = __webpack_require__(168);

	var _LogError2 = _interopRequireDefault(_LogError);

	var WebserviceComponent = (function (_React$Component) {
	    _inherits(WebserviceComponent, _React$Component);

	    function WebserviceComponent(props) {
	        _classCallCheck(this, WebserviceComponent);

	        _get(Object.getPrototypeOf(WebserviceComponent.prototype), 'constructor', this).call(this, props);
	    ...
	    _createClass(WebserviceComponent, [{
	        key: 'responseBodyToState',
	        value: function responseBodyToState(responseBody) {
	            return {};
	        }
	    }, {
	        key: 'refresh',
	        value: function refresh() {
	            _superagent2['default'].get(this.props.serviceURL).end((function (err, res) {
	                if (res && res.ok) {
	                    this.setState(this.responseBodyToState(res.body));
	                } else {
	                    _LogError2['default'].error('Webservice error in class "' + this.constructor.name + '": ' + err);
	                }
	            }).bind(this));
	        }
	    }, {
	...
	WebserviceComponent.propTypes = {
	    refreshInterval: _react2['default'].PropTypes.number.isRequired,
	    serviceURL: _react2['default'].PropTypes.string.isRequired
	};

	exports['default'] = WebserviceComponent;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var request = module.exports = __webpack_require__(167).bind(null, Request);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormData = __webpack_require__(166); // browserify compatible
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AbsenceItemComponent = __webpack_require__(171);

	var _AbsenceItemComponent2 = _interopRequireDefault(_AbsenceItemComponent);

	var AbsencePersonComponent = (function (_React$Component) {
	    _inherits(AbsencePersonComponent, _React$Component);

	    function AbsencePersonComponent() {
	        _classCallCheck(this, AbsencePersonComponent);

	        _get(Object.getPrototypeOf(AbsencePersonComponent.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(AbsencePersonComponent, [{
	        key: 'render',
	        value: function render() {
	            var empty = '';
	            ...
	            return _react2['default'].createElement(
	                ...
	                this.props.items.map(function (item, index) {
	                    return _react2['default'].createElement(_AbsenceItemComponent2['default'], _extends({}, item, { key: index }));
	                }),
	                empty
	            );
	        }
	...
	exports['default'] = AbsencePersonComponent;
	module.exports = exports['default'];
